...
module.exports = ({ DEV, CHAT_KEEP, G, send, fail, broadcast, Room, addBot, playCard, bidValue,
                    markPresence }) => {
  const { curRound, seatIndex, syncCfg, seatBid, scoreRound, bumDeal, Deck } = Room;
  ...
  const MESSAGES = {
    ...
    dealt: {
      ...
      run(c) { Room.seatReady(c.room, c.mySeat); },
    },
