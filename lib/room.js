...
module.exports = ({ G, A, token, saveGame, DEV, Trail }) => {
  ...
  return { curRound, seatIndex, Deck, BID_HOLD, create, seat, syncCfg, become, addBot, openRound, startGame, toLobby,
           kickSeat, standDown, letBack, unstick, setDealer, renameSeat, resetRound, setScore, idleSeat, idleTable, sweep, carryOn,
           seatBid, seatReady, closeBidding, openPlay, countTrick, uncountTrick, bumDeal, scoreRound, finishGame, unfinish, setPaused,
