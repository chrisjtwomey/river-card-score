...
module.exports = ({ G, A, token, saveGame, DEV }) => {
  ...
  return { curRound, seatIndex, Deck, BID_HOLD, create, seat, syncCfg, addBot, openRound, startGame, toLobby,
           seatBid, seatReady, closeBidding, openPlay, countTrick, uncountTrick, bumDeal, scoreRound, finishGame, unfinish, undo,
